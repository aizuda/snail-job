import{d as z,aj as r,b6 as W,dN as j,dO as q,dP as O,dQ as G,a as x,dR as w,bp as P,b5 as s,bq as C,b8 as _,bb as T,dS as A,bw as D,be as L}from"./index-D6me0eLt.js";const M={success:r(G,null),error:r(O,null),warning:r(q,null),info:r(j,null)},X=z({name:"ProgressCircle",props:{clsPrefix:{type:String,required:!0},status:{type:String,required:!0},strokeWidth:{type:Number,required:!0},fillColor:[String,Object],railColor:String,railStyle:[String,Object],percentage:{type:Number,default:0},offsetDegree:{type:Number,default:0},showIndicator:{type:Boolean,required:!0},indicatorTextColor:String,unit:String,viewBoxWidth:{type:Number,required:!0},gapDegree:{type:Number,required:!0},gapOffsetDegree:{type:Number,default:0}},setup(e,{slots:p}){function u(n,o,t,l){const{gapDegree:c,viewBoxWidth:f,strokeWidth:y}=e,d=50,g=0,h=d,i=0,a=2*d,$=50+y/2,S=`M ${$},${$} m ${g},${h}
      a ${d},${d} 0 1 1 ${i},-100
