import{bo as p,b3 as e,bM as F,bp as C,bu as O,dw as G,dx as H,d as E,b4 as K,b7 as L,dy as N,a as j,bv as k,ba as W,bX as X,dz as q,al as n,dA as J,dB as Q}from"./index-U8_FYD1k.js";function D(r,b="default",a=[]){const{children:i}=r;if(i!==null&&typeof i=="object"&&!Array.isArray(i)){const l=i[b];if(typeof l=="function")return l()}return a}const V="DESCRIPTION_ITEM_FLAG";function U(r){return typeof r=="object"&&r&&!Array.isArray(r)?r.type&&r.type[V]:!1}const Y=p([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
