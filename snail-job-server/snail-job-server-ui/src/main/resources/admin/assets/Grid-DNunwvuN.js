...
`,[z("pagination-prefix",`
 ...
 `)]),it("disabled",[I("hover",Qt,Jt),q("&:hover",Qt,Jt),q("&:active",`
...
`,[fe("splitor",`
 ...
 `),it("checked",{color:"var(--n-button-text-color-hover)"})]),I("focus",[q("&:not(:active)",[fe("state-border",{boxShadow:"var(--n-button-box-shadow-focus)"})])])]),I("checked",`
 ...
 transition: color .3s var(--n-bezier);
 `,[I("expanded",[z("icon","transform: rotate(90deg);",[dt({originalTransform:"rotate(90deg)"})]),z("base-icon","transform: rotate(90deg);",[dt({originalTransform:"rotate(90deg)"})])]),z("base-loading",`
 color: var(--n-loading-color);
 transition: color .3s var(--n-bezier);
 position: absolute;
 left: 0;
 ...
 box-sizing: border-box;
 `),I("striped","background-color: var(--n-merged-td-color-striped);",[z("data-table-td","background-color: var(--n-merged-td-color-striped);")]),it("summary",[q("&:hover","background-color: var(--n-merged-td-color-hover);",[q(">",[z("data-table-td","background-color: var(--n-merged-td-color-hover);")])])])]),z("data-table-th",`
 padding: var(--n-th-padding);
 position: relative;
 text-align: start;
 box-sizing: border-box;
 ...
 `))]);function Do(){return[I("fixed-left",`
 left: 0;
 position: sticky;
 z-index: 2;
 `,[q("&::after",`
