...
`)}const ko=J({name:"DataTableFilterMenu",props:{column:{type:Object,required:!0},radioGroupName:{type:String,required:!0},multiple:{type:Boolean,required:!0},value:{type:[Array,String,Number],default:null},options:{type:Array,required:!0},onConfirm:{type:Function,required:!0},onClear:{type:Function,required:!0},onChange:{type:Function,required:!0}},setup(e){const{mergedClsPrefixRef:t,mergedRtlRef:n}=$e(e),r=at("DataTable",n,t),{mergedClsPrefixRef:o,mergedThemeRef:i,localeRef:u}=Se(Oe),d=K(e.value),s=R(()=>{const{value:c}=d;return Array.isArray(c)?c:null}),l=R(()=>{const{value:c}=d;return mt(e.column)?Array.isArray(c)&&c.length&&c[0]||null:Array.isArray(c)?null:c});function v(c){e.onChange(c)}function p(c){e.multiple&&Array.isArray(c)?d.value=c:mt(e.column)&&!Array.isArray(c)?d.value=[c]:d.value=c}function m(){v(d.value),e.onConfirm()}function h(){e.multiple||mt(e.column)?v([]):v(null),e.onClear()}return{mergedClsPrefix:o,rtlEnabled:r,mergedTheme:i,locale:u,checkboxGroupValue:s,radioGroupValue:l,handleChange:p,handleConfirmClick:m,handleClearClick:h}},render(){const{mergedTheme:e,locale:t,mergedClsPrefix:n}=this;return a("div",{class:[`${n}-data-table-filter-menu`,this.rtlEnabled&&`${n}-data-table-filter-menu--rtl`]},a(fn,null,{default:()=>{const{checkboxGroupValue:r,handleChange:o}=this;return this.multiple?a(wr,{value:r,class:`${n}-data-table-filter-menu__group`,onUpdateValue:o},{default:()=>this.options.map(i=>a(St,{key:i.value,theme:e.peers.Checkbox,themeOverrides:e.peerOverrides.Checkbox,value:i.value},{default:()=>i.label}))}):a(po,{name:this.radioGroupName,class:`${n}-data-table-filter-menu__group`,value:this.radioGroupValue,onUpdateValue:this.handleChange},{default:()=>this.options.map(i=>a(bn,{key:i.value,value:i.value,theme:e.peers.Radio,themeOverrides:e.peerOverrides.Radio},{default:()=>i.label}))})}}),a("div",{class:`${n}-data-table-filter-menu__action`},a(Mt,{size:"tiny",theme:e.peers.Button,themeOverrides:e.peerOverrides.Button,onClick:this.handleClearClick},{default:()=>t.clear}),a(Mt,{theme:e.peers.Button,themeOverrides:e.peerOverrides.Button,type:"primary",size:"tiny",onClick:this.handleConfirmClick},{default:()=>t.confirm})))}}),So=J({name:"DataTableRenderFilter",props:{render:{type:Function,required:!0},active:{type:Boolean,default:!1},show:{type:Boolean,default:!1}},render(){const{render:e,active:t,show:n}=this;return e({active:t,show:n})}});function Po(e,t,n){const r=Object.assign({},e);return r[t]=n,r}const Fo=J({name:"DataTableFilterButton",props:{column:{type:Object,required:!0},options:{type:Array,default:()=>[]}},setup(e){const{mergedComponentPropsRef:t}=$e(),{mergedThemeRef:n,mergedClsPrefixRef:r,mergedFilterStateRef:o,filterMenuCssVarsRef:i,paginationBehaviorOnFilterRef:u,doUpdatePage:d,doUpdateFilters:s,filterIconPopoverPropsRef:l}=Se(Oe),v=K(!1),p=o,m=R(()=>e.column.filterMultiple!==!1),h=R(()=>{const P=p.value[e.column.key];if(P===void 0){const{value:T}=m;return T?[]:null}return P}),c=R(()=>{const{value:P}=h;return Array.isArray(P)?P.length>0:P!==null}),f=R(()=>{var P,T;return((T=(P=t==null?void 0:t.value)===null||P===void 0?void 0:P.DataTable)===null||T===void 0?void 0:T.renderFilter)||e.column.renderFilter});function b(P){const T=Po(p.value,e.column.key,P);s(T,e.column),u.value==="first"&&d(1)}function x(){v.value=!1}function y(){v.value=!1}return{mergedTheme:n,mergedClsPrefix:r,active:c,showPopover:v,mergedRenderFilter:f,filterIconPopoverProps:l,filterMultiple:m,mergedFilterValue:h,filterMenuCssVars:i,handleFilterChange:b,handleFilterMenuConfirm:y,handleFilterMenuCancel:x}},render(){const{mergedTheme:e,mergedClsPrefix:t,handleFilterMenuCancel:n,filterIconPopoverProps:r}=this;return a(an,Object.assign({show:this.showPopover,onUpdateShow:o=>this.showPopover=o,trigger:"click",theme:e.peers.Popover,themeOverrides:e.peerOverrides.Popover,placement:"bottom"},r,{style:{padding:0}}),{trigger:()=>{const{mergedRenderFilter:o}=this;if(o)return a(So,{"data-data-table-filter":!0,render:o,active:this.active,show:this.showPopover});const{renderFilterIcon:i}=this.column;return a("div",{"data-data-table-filter":!0,class:[`${t}-data-table-filter`,{[`${t}-data-table-filter--active`]:this.active,[`${t}-data-table-filter--show`]:this.showPopover}]},i?i({active:this.active,show:this.showPopover}):a(Ue,{clsPrefix:t},{default:()=>a(qr,null)}))},default:()=>{const{renderFilterMenu:o}=this.column;return o?o({hide:n}):a(ko,{style:this.filterMenuCssVars,radioGroupName:String(this.column.key),multiple:this.filterMultiple,value:this.mergedFilterValue,options:this.options,column:this.column,onChange:this.handleFilterChange,onClear:this.handleFilterMenuCancel,onConfirm:this.handleFilterMenuConfirm})}})}}),zo=J({name:"ColumnResizeButton",props:{onResizeStart:Function,onResize:Function,onResizeEnd:Function},setup(e){const{mergedClsPrefixRef:t}=Se(Oe),n=K(!1);let r=0;function o(s){return s.clientX}function i(s){var l;s.preventDefault();const v=n.value;r=o(s),n.value=!0,v||(Bt("mousemove",window,u),Bt("mouseup",window,d),(l=e.onResizeStart)===null||l===void 0||l.call(e))}function u(s){var l;(l=e.onResize)===null||l===void 0||l.call(e,o(s)-r)}function d(){var s;n.value=!1,(s=e.onResizeEnd)===null||s===void 0||s.call(e),it("mousemove",window,u),it("mouseup",window,d)}return Yt(()=>{it("mousemove",window,u),it("mouseup",window,d)}),{mergedClsPrefix:t,active:n,handleMousedown:i}},render(){const{mergedClsPrefix:e}=this;return a("span",{"data-data-table-resizable":!0,class:[`${e}-data-table-resize-button`,this.active&&`${e}-data-table-resize-button--active`],onMousedown:this.handleMousedown})}}),Rn="_n_all__",kn="_n_none__";function _o(e,t,n,r){return e?o=>{for(const i of e)switch(o){case Rn:n(!0);return;case kn:r(!0);return;default:if(typeof i=="object"&&i.key===o){i.onSelect(t.value);return}}}:()=>{}}function Mo(e,t){return e?e.map(n=>{switch(n){case"all":return{label:t.checkTableAll,key:Rn};case"none":return{label:t.uncheckTableAll,key:kn};default:return n}}):[]}const Bo=J({name:"DataTableSelectionMenu",props:{clsPrefix:{type:String,required:!0}},setup(e){const{props:t,localeRef:n,checkOptionsRef:r,rawPaginatedDataRef:o,doCheckAll:i,doUncheckAll:u}=Se(Oe),d=R(()=>_o(r.value,o,i,u)),s=R(()=>Mo(r.value,n.value));return()=>{var l,v,p,m;const{clsPrefix:h}=e;return a(kr,{theme:(v=(l=t.theme)===null||l===void 0?void 0:l.peers)===null||v===void 0?void 0:v.Dropdown,themeOverrides:(m=(p=t.themeOverrides)===null||p===void 0?void 0:p.peers)===null||m===void 0?void 0:m.Dropdown,options:s.value,onSelect:d.value},{default:()=>a(Ue,{clsPrefix:h,class:`${h}-data-table-check-extra`},{default:()=>a(Rr,null)})})}}});function yt(e){return typeof e.title=="function"?e.title(e):e.title}const Sn=J({name:"DataTableHeader",props:{discrete:{type:Boolean,default:!0}},setup(){const{mergedClsPrefixRef:e,scrollXRef:t,fixedColumnLeftMapRef:n,fixedColumnRightMapRef:r,mergedCurrentPageRef:o,allRowsCheckedRef:i,someRowsCheckedRef:u,rowsRef:d,colsRef:s,mergedThemeRef:l,checkOptionsRef:v,mergedSortStateRef:p,componentId:m,mergedTableLayoutRef:h,headerCheckboxDisabledRef:c,onUnstableColumnResize:f,doUpdateResizableWidth:b,handleTableHeaderScroll:x,deriveNextSorter:y,doUncheckAll:P,doCheckAll:T}=Se(Oe),w=K({});function z(U){const I=w.value[U];return I==null?void 0:I.getBoundingClientRect().width}function _(){i.value?P():T()}function B(U,I){if(tt(U,"dataTableFilter")||tt(U,"dataTableResizable")||!bt(I))return;const D=p.value.find(q=>q.columnKey===I.key)||null,H=Co(I,D);y(H)}const k=new Map;function S(U){k.set(U.key,z(U.key))}function G(U,I){const D=k.get(U.key);if(D===void 0)return;const H=D+I,q=bo(H,U.minWidth,U.maxWidth);f(H,q,U,z),b(U,q)}return{cellElsRef:w,componentId:m,mergedSortState:p,mergedClsPrefix:e,scrollX:t,fixedColumnLeftMap:n,fixedColumnRightMap:r,currentPage:o,allRowsChecked:i,someRowsChecked:u,rows:d,cols:s,mergedTheme:l,checkOptions:v,mergedTableLayout:h,headerCheckboxDisabled:c,handleCheckboxUpdateChecked:_,handleColHeaderClick:B,handleTableHeaderScroll:x,handleColumnResizeStart:S,handleColumnResize:G}},render(){const{cellElsRef:e,mergedClsPrefix:t,fixedColumnLeftMap:n,fixedColumnRightMap:r,currentPage:o,allRowsChecked:i,someRowsChecked:u,rows:d,cols:s,mergedTheme:l,checkOptions:v,componentId:p,discrete:m,mergedTableLayout:h,headerCheckboxDisabled:c,mergedSortState:f,handleColHeaderClick:b,handleCheckboxUpdateChecked:x,handleColumnResizeStart:y,handleColumnResize:P}=this,T=a("thead",{class:`${t}-data-table-thead`,"data-n-id":p},d.map(_=>a("tr",{class:`${t}-data-table-tr`},_.map(({column:B,colSpan:k,rowSpan:S,isLast:G})=>{var U,I;const D=_e(B),{ellipsis:H}=B,q=()=>B.type==="selection"?B.multiple!==!1?a(rt,null,a(St,{key:o,privateInsideTable:!0,checked:i,indeterminate:u,disabled:c,onUpdateChecked:x}),v?a(Bo,{clsPrefix:t}):null):null:a(rt,null,a("div",{class:`${t}-data-table-th__title-wrapper`},a("div",{class:`${t}-data-table-th__title`},H===!0||H&&!H.tooltip?a("div",{class:`${t}-data-table-th__ellipsis`},yt(B)):H&&typeof H=="object"?a(kt,Object.assign({},H,{theme:l.peers.Ellipsis,themeOverrides:l.peerOverrides.Ellipsis}),{default:()=>yt(B)}):yt(B)),bt(B)?a(io,{column:B}):null),Gt(B)?a(Fo,{column:B,options:B.filterOptions}):null,Cn(B)?a(zo,{onResizeStart:()=>{y(B)},onResize:he=>{P(B,he)}}):null),le=D in n,oe=D in r;return a("th",{ref:he=>e[D]=he,key:D,style:{textAlign:B.titleAlign||B.align,left:Me((U=n[D])===null||U===void 0?void 0:U.start),right:Me((I=r[D])===null||I===void 0?void 0:I.start)},colspan:k,rowspan:S,"data-col-key":D,class:[`${t}-data-table-th`,(le||oe)&&`${t}-data-table-th--fixed-${le?"left":"right"}`,{[`${t}-data-table-th--sorting`]:wn(B,f),[`${t}-data-table-th--filterable`]:Gt(B),[`${t}-data-table-th--sortable`]:bt(B),[`${t}-data-table-th--selection`]:B.type==="selection",[`${t}-data-table-th--last`]:G},B.className],onClick:B.type!=="selection"&&B.type!=="expand"&&!("children"in B)?he=>{b(he,B)}:void 0},q())}))));if(!m)return T;const{handleTableHeaderScroll:w,scrollX:z}=this;return a("div",{class:`${t}-data-table-base-table-header`,onScroll:w},a("table",{ref:"body",class:`${t}-data-table-table`,style:{minWidth:Be(z),tableLayout:h}},a("colgroup",null,s.map(_=>a("col",{key:_.key,style:_.style}))),T))}}),$o=J({name:"DataTableCell",props:{clsPrefix:{type:String,required:!0},row:{type:Object,required:!0},index:{type:Number,required:!0},column:{type:Object,required:!0},isSummary:Boolean,mergedTheme:{type:Object,required:!0},renderCell:Function},render(){var e;const{isSummary:t,column:n,row:r,renderCell:o}=this;let i;const{render:u,key:d,ellipsis:s}=n;if(u&&!t?i=u(r,this.index):t?i=(e=r[d])===null||e===void 0?void 0:e.value:i=o?o($t(r,d),r,n):$t(r,d),s)if(typeof s=="object"){const{mergedTheme:l}=this;return n.ellipsisComponent==="performant-ellipsis"?a(ro,Object.assign({},s,{theme:l.peers.Ellipsis,themeOverrides:l.peerOverrides.Ellipsis}),{default:()=>i}):a(kt,Object.assign({},s,{theme:l.peers.Ellipsis,themeOverrides:l.peerOverrides.Ellipsis}),{default:()=>i})}else return a("span",{class:`${this.clsPrefix}-data-table-td__ellipsis`},i);return i}}),Xt=J({name:"DataTableExpandTrigger",props:{clsPrefix:{type:String,required:!0},expanded:Boolean,loading:Boolean,onClick:{type:Function,required:!0},renderExpandIcon:{type:Function}},render(){const{clsPrefix:e}=this;return a("div",{class:[`${e}-data-table-expand-trigger`,this.expanded&&`${e}-data-table-expand-trigger--expanded`],onClick:this.onClick,onMousedown:t=>{t.preventDefault()}},a(Sr,null,{default:()=>this.loading?a(hn,{key:"loading",clsPrefix:this.clsPrefix,radius:85,strokeWidth:15,scale:.88}):this.renderExpandIcon?this.renderExpandIcon({expanded:this.expanded}):a(Ue,{clsPrefix:e,key:"base-icon"},{default:()=>a(Pr,null)})}))}}),To=J({name:"DataTableBodyCheckbox",props:{rowKey:{type:[String,Number],required:!0},disabled:{type:Boolean,required:!0},onUpdateChecked:{type:Function,required:!0}},setup(e){const{mergedCheckedRowKeySetRef:t,mergedInderminateRowKeySetRef:n}=Se(Oe);return()=>{const{rowKey:r}=e;return a(St,{privateInsideTable:!0,disabled:e.disabled,indeterminate:n.value.has(r),checked:t.value.has(r),onUpdateChecked:e.onUpdateChecked})}}}),Oo=J({name:"DataTableBodyRadio",props:{rowKey:{type:[String,Number],required:!0},disabled:{type:Boolean,required:!0},onUpdateChecked:{type:Function,required:!0}},setup(e){const{mergedCheckedRowKeySetRef:t,componentId:n}=Se(Oe);return()=>{const{rowKey:r}=e;return a(bn,{name:n,disabled:e.disabled,checked:t.value.has(r),onUpdateChecked:e.onUpdateChecked})}}});function Eo(e,t){const n=[];function r(o,i){o.forEach(u=>{u.children&&t.has(u.key)?(n.push({tmNode:u,striped:!1,key:u.key,index:i}),r(u.children,i)):n.push({key:u.key,tmNode:u,striped:!1,index:i})})}return e.forEach(o=>{n.push(o);const{children:i}=o.tmNode;i&&t.has(o.key)&&r(i,o.index)}),n}const Ao=J({props:{clsPrefix:{type:String,required:!0},id:{type:String,required:!0},cols:{type:Array,required:!0},onMouseenter:Function,onMouseleave:Function},render(){const{clsPrefix:e,id:t,cols:n,onMouseenter:r,onMouseleave:o}=this;return a("table",{style:{tableLayout:"fixed"},class:`${e}-data-table-table`,onMouseenter:r,onMouseleave:o},a("colgroup",null,n.map(i=>a("col",{key:i.key,style:i.style}))),a("tbody",{"data-n-id":t,class:`${e}-data-table-tbody`},this.$slots))}}),Lo=J({name:"DataTableBody",props:{onResize:Function,showHeader:Boolean,flexHeight:Boolean,bodyStyle:Object},setup(e){const{slots:t,bodyWidthRef:n,mergedExpandedRowKeysRef:r,mergedClsPrefixRef:o,mergedThemeRef:i,scrollXRef:u,colsRef:d,paginatedDataRef:s,rawPaginatedDataRef:l,fixedColumnLeftMapRef:v,fixedColumnRightMapRef:p,mergedCurrentPageRef:m,rowClassNameRef:h,leftActiveFixedColKeyRef:c,leftActiveFixedChildrenColKeysRef:f,rightActiveFixedColKeyRef:b,rightActiveFixedChildrenColKeysRef:x,renderExpandRef:y,hoverKeyRef:P,summaryRef:T,mergedSortStateRef:w,virtualScrollRef:z,componentId:_,mergedTableLayoutRef:B,childTriggerColIndexRef:k,indentRef:S,rowPropsRef:G,maxHeightRef:U,stripedRef:I,loadingRef:D,onLoadRef:H,loadingKeySetRef:q,expandableRef:le,stickyExpandedRowsRef:oe,renderExpandIconRef:he,summaryPlacementRef:Y,treeMateRef:C,scrollbarPropsRef:M,setHeaderScrollLeft:L,doUpdateExpandedRowKeys:$,handleTableBodyScroll:j,doCheck:se,doUncheck:de,renderCell:ae}=Se(Oe),g=K(null),N=K(null),pe=K(null),ve=ke(()=>s.value.length===0),V=ke(()=>e.showHeader||!ve.value),te=ke(()=>e.showHeader||ve.value);let Fe="";const be=R(()=>new Set(r.value));function me(O){var W;return(W=C.value.getNode(O))===null||W===void 0?void 0:W.rawNode}function je(O,W,re){const E=me(O.key);if(!E){Tt("data-table",`fail to get row data with key ${O.key}`);return}if(re){const ee=s.value.findIndex(ye=>ye.key===Fe);if(ee!==-1){const ye=s.value.findIndex(Pe=>Pe.key===O.key),Q=Math.min(ee,ye),ie=Math.max(ee,ye),ue=[];s.value.slice(Q,ie+1).forEach(Pe=>{Pe.disabled||ue.push(Pe.key)}),W?se(ue,!1,E):de(ue,E),Fe=O.key;return}}W?se(O.key,!1,E):de(O.key,E),Fe=O.key}function Ve(O){const W=me(O.key);if(!W){Tt("data-table",`fail to get row data with key ${O.key}`);return}se(O.key,!0,W)}function we(){if(!V.value){const{value:W}=pe;return W||null}if(z.value)return De();const{value:O}=g;return O?O.containerRef:null}function Re(O,W){var re;if(q.value.has(O))return;const{value:E}=r,ee=E.indexOf(O),ye=Array.from(E);~ee?(ye.splice(ee,1),$(ye)):W&&!W.isLeaf&&!W.shallowLoaded?(q.value.add(O),(re=H.value)===null||re===void 0||re.call(H,W.rawNode).then(()=>{const{value:Q}=r,ie=Array.from(Q);~ie.indexOf(O)||ie.push(O),$(ie)}).finally(()=>{q.value.delete(O)})):(ye.push(O),$(ye))}function Ie(){P.value=null}function De(){const{value:O}=N;return(O==null?void 0:O.listElRef)||null}function He(){const{value:O}=N;return(O==null?void 0:O.itemsElRef)||null}function Xe(O){var W;j(O),(W=g.value)===null||W===void 0||W.sync()}function Ee(O){var W;const{onResize:re}=e;re&&re(O),(W=g.value)===null||W===void 0||W.sync()}const ge={getScrollContainer:we,scrollTo(O,W){var re,E;z.value?(re=N.value)===null||re===void 0||re.scrollTo(O,W):(E=g.value)===null||E===void 0||E.scrollTo(O,W)}},Ae=X([({props:O})=>{const W=E=>E===null?null:X(`[data-n-id="${O.componentId}"] [data-col-key="${E}"]::after`,{boxShadow:"var(--n-box-shadow-after)"}),re=E=>E===null?null:X(`[data-n-id="${O.componentId}"] [data-col-key="${E}"]::before`,{boxShadow:"var(--n-box-shadow-before)"});return X([W(O.leftActiveFixedColKey),re(O.rightActiveFixedColKey),O.leftActiveFixedChildrenColKeys.map(E=>W(E)),O.rightActiveFixedChildrenColKeys.map(E=>re(E))])}]);let Le=!1;return nt(()=>{const{value:O}=c,{value:W}=f,{value:re}=b,{value:E}=x;if(!Le&&O===null&&re===null)return;const ee={leftActiveFixedColKey:O,leftActiveFixedChildrenColKeys:W,rightActiveFixedColKey:re,rightActiveFixedChildrenColKeys:E,componentId:_};Ae.mount({id:`n-${_}`,force:!0,props:ee,anchorMetaName:_r}),Le=!0}),Fr(()=>{Ae.unmount({id:`n-${_}`})}),Object.assign({bodyWidth:n,summaryPlacement:Y,dataTableSlots:t,componentId:_,scrollbarInstRef:g,virtualListRef:N,emptyElRef:pe,summary:T,mergedClsPrefix:o,mergedTheme:i,scrollX:u,cols:d,loading:D,bodyShowHeaderOnly:te,shouldDisplaySomeTablePart:V,empty:ve,paginatedDataAndInfo:R(()=>{const{value:O}=I;let W=!1;return{data:s.value.map(O?(E,ee)=>(E.isLeaf||(W=!0),{tmNode:E,key:E.key,striped:ee%2===1,index:ee}):(E,ee)=>(E.isLeaf||(W=!0),{tmNode:E,key:E.key,striped:!1,index:ee})),hasChildren:W}}),rawPaginatedData:l,fixedColumnLeftMap:v,fixedColumnRightMap:p,currentPage:m,rowClassName:h,renderExpand:y,mergedExpandedRowKeySet:be,hoverKey:P,mergedSortState:w,virtualScroll:z,mergedTableLayout:B,childTriggerColIndex:k,indent:S,rowProps:G,maxHeight:U,loadingKeySet:q,expandable:le,stickyExpandedRows:oe,renderExpandIcon:he,scrollbarProps:M,setHeaderScrollLeft:L,handleVirtualListScroll:Xe,handleVirtualListResize:Ee,handleMouseleaveTable:Ie,virtualListContainer:De,virtualListContent:He,handleTableBodyScroll:j,handleCheckboxUpdateChecked:je,handleRadioUpdateChecked:Ve,handleUpdateExpanded:Re,renderCell:ae},ge)},render(){const{mergedTheme:e,scrollX:t,mergedClsPrefix:n,virtualScroll:r,maxHeight:o,mergedTableLayout:i,flexHeight:u,loadingKeySet:d,onResize:s,setHeaderScrollLeft:l}=this,v=t!==void 0||o!==void 0||u,p=!v&&i==="auto",m=t!==void 0||p,h={minWidth:Be(t)||"100%"};t&&(h.width="100%");const c=a(fn,Object.assign({},this.scrollbarProps,{ref:"scrollbarInstRef",scrollable:v||p,class:`${n}-data-table-base-table-body`,style:this.empty?void 0:this.bodyStyle,theme:e.peers.Scrollbar,themeOverrides:e.peerOverrides.Scrollbar,contentStyle:h,container:r?this.virtualListContainer:void 0,content:r?this.virtualListContent:void 0,horizontalRailStyle:{zIndex:3},verticalRailStyle:{zIndex:3},xScrollable:m,onScroll:r?void 0:this.handleTableBodyScroll,internalOnUpdateScrollLeft:l,onResize:s}),{default:()=>{const f={},b={},{cols:x,paginatedDataAndInfo:y,mergedTheme:P,fixedColumnLeftMap:T,fixedColumnRightMap:w,currentPage:z,rowClassName:_,mergedSortState:B,mergedExpandedRowKeySet:k,stickyExpandedRows:S,componentId:G,childTriggerColIndex:U,expandable:I,rowProps:D,handleMouseleaveTable:H,renderExpand:q,summary:le,handleCheckboxUpdateChecked:oe,handleRadioUpdateChecked:he,handleUpdateExpanded:Y}=this,{length:C}=x;let M;const{data:L,hasChildren:$}=y,j=$?Eo(L,k):L;if(le){const V=le(this.rawPaginatedData);if(Array.isArray(V)){const te=V.map((Fe,be)=>({isSummaryRow:!0,key:`__n_summary__${be}`,tmNode:{rawNode:Fe,disabled:!0},index:-1}));M=this.summaryPlacement==="top"?[...te,...j]:[...j,...te]}else{const te={isSummaryRow:!0,key:"__n_summary__",tmNode:{rawNode:V,disabled:!0},index:-1};M=this.summaryPlacement==="top"?[te,...j]:[...j,te]}}else M=j;const se=$?{width:Me(this.indent)}:void 0,de=[];M.forEach(V=>{q&&k.has(V.key)&&(!I||I(V.tmNode.rawNode))?de.push(V,{isExpandedRow:!0,key:`${V.key}-expand`,tmNode:V.tmNode,index:V.index}):de.push(V)});const{length:ae}=de,g={};L.forEach(({tmNode:V},te)=>{g[te]=V.key});const N=S?this.bodyWidth:null,pe=N===null?void 0:`${N}px`,ve=(V,te,Fe)=>{const{index:be}=V;if("isExpandedRow"in V){const{tmNode:{key:Ee,rawNode:ge}}=V;return a("tr",{class:`${n}-data-table-tr ${n}-data-table-tr--expanded`,key:`${Ee}__expand`},a("td",{class:[`${n}-data-table-td`,`${n}-data-table-td--last-col`,te+1===ae&&`${n}-data-table-td--last-row`],colspan:C},S?a("div",{class:`${n}-data-table-expand`,style:{width:pe}},q(ge,be)):q(ge,be)))}const me="isSummaryRow"in V,je=!me&&V.striped,{tmNode:Ve,key:we}=V,{rawNode:Re}=Ve,Ie=k.has(we),De=D?D(Re,be):void 0,He=typeof _=="string"?_:xo(Re,be,_);return a("tr",Object.assign({onMouseenter:()=>{this.hoverKey=we},key:we,class:[`${n}-data-table-tr`,me&&`${n}-data-table-tr--summary`,je&&`${n}-data-table-tr--striped`,Ie&&`${n}-data-table-tr--expanded`,He]},De),x.map((Ee,ge)=>{var Ae,Le,O,W,re;if(te in f){const xe=f[te],Ce=xe.indexOf(ge);if(~Ce)return xe.splice(Ce,1),null}const{column:E}=Ee,ee=_e(Ee),{rowSpan:ye,colSpan:Q}=E,ie=me?((Ae=V.tmNode.rawNode[ee])===null||Ae===void 0?void 0:Ae.colSpan)||1:Q?Q(Re,be):1,ue=me?((Le=V.tmNode.rawNode[ee])===null||Le===void 0?void 0:Le.rowSpan)||1:ye?ye(Re,be):1,Pe=ge+ie===C,We=te+ue===ae,Ne=ue>1;if(Ne&&(b[te]={[ge]:[]}),ie>1||Ne)for(let xe=te;xe<te+ue;++xe){Ne&&b[te][ge].push(g[xe]);for(let Ce=ge;Ce<ge+ie;++Ce)xe===te&&Ce===ge||(xe in f?f[xe].push(Ce):f[xe]=[Ce])}const Ke=Ne?this.hoverKey:null,{cellProps:Ge}=E,ze=Ge==null?void 0:Ge(Re,be),Ze={"--indent-offset":""};return a("td",Object.assign({},ze,{key:ee,style:[{textAlign:E.align||void 0,left:Me((O=T[ee])===null||O===void 0?void 0:O.start),right:Me((W=w[ee])===null||W===void 0?void 0:W.start)},Ze,(ze==null?void 0:ze.style)||""],colspan:ie,rowspan:Fe?void 0:ue,"data-col-key":ee,class:[`${n}-data-table-td`,E.className,ze==null?void 0:ze.class,me&&`${n}-data-table-td--summary`,Ke!==null&&b[te][ge].includes(Ke)&&`${n}-data-table-td--hover`,wn(E,B)&&`${n}-data-table-td--sorting`,E.fixed&&`${n}-data-table-td--fixed-${E.fixed}`,E.align&&`${n}-data-table-td--${E.align}-align`,E.type==="selection"&&`${n}-data-table-td--selection`,E.type==="expand"&&`${n}-data-table-td--expand`,Pe&&`${n}-data-table-td--last-col`,We&&`${n}-data-table-td--last-row`]}),$&&ge===U?[Mr(Ze["--indent-offset"]=me?0:V.tmNode.level,a("div",{class:`${n}-data-table-indent`,style:se})),me||V.tmNode.isLeaf?a("div",{class:`${n}-data-table-expand-placeholder`}):a(Xt,{class:`${n}-data-table-expand-trigger`,clsPrefix:n,expanded:Ie,renderExpandIcon:this.renderExpandIcon,loading:d.has(V.key),onClick:()=>{Y(we,V.tmNode)}})]:null,E.type==="selection"?me?null:E.multiple===!1?a(Oo,{key:z,rowKey:we,disabled:V.tmNode.disabled,onUpdateChecked:()=>{he(V.tmNode)}}):a(To,{key:z,rowKey:we,disabled:V.tmNode.disabled,onUpdateChecked:(xe,Ce)=>{oe(V.tmNode,xe,Ce.shiftKey)}}):E.type==="expand"?me?null:!E.expandable||!((re=E.expandable)===null||re===void 0)&&re.call(E,Re)?a(Xt,{clsPrefix:n,expanded:Ie,renderExpandIcon:this.renderExpandIcon,onClick:()=>{Y(we,null)}}):null:a($o,{clsPrefix:n,index:be,row:Re,column:E,isSummary:me,mergedTheme:P,renderCell:this.renderCell}))}))};return r?a(zr,{ref:"virtualListRef",items:de,itemSize:28,visibleItemsTag:Ao,visibleItemsProps:{clsPrefix:n,id:G,cols:x,onMouseleave:H},showScrollbar:!1,onResize:this.handleVirtualListResize,onScroll:this.handleVirtualListScroll,itemsStyle:h,itemResizable:!0},{default:({item:V,index:te})=>ve(V,te,!0)}):a("table",{class:`${n}-data-table-table`,onMouseleave:H,style:{tableLayout:this.mergedTableLayout}},a("colgroup",null,x.map(V=>a("col",{key:V.key,style:V.style}))),this.showHeader?a(Sn,{discrete:!1}):null,this.empty?null:a("tbody",{"data-n-id":G,class:`${n}-data-table-tbody`},de.map((V,te)=>ve(V,te,!1))))}});if(this.empty){const f=()=>a("div",{class:[`${n}-data-table-empty`,this.loading&&`${n}-data-table-empty--hide`],style:this.bodyStyle,ref:"emptyElRef"},Rt(this.dataTableSlots.empty,()=>[a(Br,{theme:this.mergedTheme.peers.Empty,themeOverrides:this.mergedTheme.peerOverrides.Empty})]));return this.shouldDisplaySomeTablePart?a(rt,null,c,f()):a(vn,{onResize:this.onResize},{default:f})}return c}}),No=J({name:"MainTable",setup(){const{mergedClsPrefixRef:e,rightFixedColumnsRef:t,leftFixedColumnsRef:n,bodyWidthRef:r,maxHeightRef:o,minHeightRef:i,flexHeightRef:u,syncScrollState:d}=Se(Oe),s=K(null),l=K(null),v=K(null),p=K(!(n.value.length||t.value.length)),m=R(()=>({maxHeight:Be(o.value),minHeight:Be(i.value)}));function h(x){r.value=x.contentRect.width,d(),p.value||(p.value=!0)}function c(){const{value:x}=s;return x?x.$el:null}function f(){const{value:x}=l;return x?x.getScrollContainer():null}const b={getBodyElement:f,getHeaderElement:c,scrollTo(x,y){var P;(P=l.value)===null||P===void 0||P.scrollTo(x,y)}};return nt(()=>{const{value:x}=v;if(!x)return;const y=`${e.value}-data-table-base-table--transition-disabled`;p.value?setTimeout(()=>{x.classList.remove(y)},0):x.classList.add(y)}),Object.assign({maxHeight:o,mergedClsPrefix:e,selfElRef:v,headerInstRef:s,bodyInstRef:l,bodyStyle:m,flexHeight:u,handleBodyResize:h},b)},render(){const{mergedClsPrefix:e,maxHeight:t,flexHeight:n}=this,r=t===void 0&&!n;return a("div",{class:`${e}-data-table-base-table`,ref:"selfElRef"},r?null:a(Sn,{ref:"headerInstRef"}),a(Lo,{ref:"bodyInstRef",bodyStyle:this.bodyStyle,showHeader:r,flexHeight:n,onResize:this.handleBodyResize}))}});function Uo(e,t){const{paginatedDataRef:n,treeMateRef:r,selectionColumnRef:o}=t,i=K(e.defaultCheckedRowKeys),u=R(()=>{var w;const{checkedRowKeys:z}=e,_=z===void 0?i.value:z;return((w=o.value)===null||w===void 0?void 0:w.multiple)===!1?{checkedKeys:_.slice(0,1),indeterminateKeys:[]}:r.value.getCheckedKeys(_,{cascade:e.cascade,allowNotLoaded:e.allowCheckingNotLoaded})}),d=R(()=>u.value.checkedKeys),s=R(()=>u.value.indeterminateKeys),l=R(()=>new Set(d.value)),v=R(()=>new Set(s.value)),p=R(()=>{const{value:w}=l;return n.value.reduce((z,_)=>{const{key:B,disabled:k}=_;return z+(!k&&w.has(B)?1:0)},0)}),m=R(()=>n.value.filter(w=>w.disabled).length),h=R(()=>{const{length:w}=n.value,{value:z}=v;return p.value>0&&p.value<w-m.value||n.value.some(_=>z.has(_.key))}),c=R(()=>{const{length:w}=n.value;return p.value!==0&&p.value===w-m.value}),f=R(()=>n.value.length===0);function b(w,z,_){const{"onUpdate:checkedRowKeys":B,onUpdateCheckedRowKeys:k,onCheckedRowKeysChange:S}=e,G=[],{value:{getNode:U}}=r;w.forEach(I=>{var D;const H=(D=U(I))===null||D===void 0?void 0:D.rawNode;G.push(H)}),B&&Z(B,w,G,{row:z,action:_}),k&&Z(k,w,G,{row:z,action:_}),S&&Z(S,w,G,{row:z,action:_}),i.value=w}function x(w,z=!1,_){if(!e.loading){if(z){b(Array.isArray(w)?w.slice(0,1):[w],_,"check");return}b(r.value.check(w,d.value,{cascade:e.cascade,allowNotLoaded:e.allowCheckingNotLoaded}).checkedKeys,_,"check")}}function y(w,z){e.loading||b(r.value.uncheck(w,d.value,{cascade:e.cascade,allowNotLoaded:e.allowCheckingNotLoaded}).checkedKeys,z,"uncheck")}function P(w=!1){const{value:z}=o;if(!z||e.loading)return;const _=[];(w?r.value.treeNodes:n.value).forEach(B=>{B.disabled||_.push(B.key)}),b(r.value.check(_,d.value,{cascade:!0,allowNotLoaded:e.allowCheckingNotLoaded}).checkedKeys,void 0,"checkAll")}function T(w=!1){const{value:z}=o;if(!z||e.loading)return;const _=[];(w?r.value.treeNodes:n.value).forEach(B=>{B.disabled||_.push(B.key)}),b(r.value.uncheck(_,d.value,{cascade:!0,allowNotLoaded:e.allowCheckingNotLoaded}).checkedKeys,void 0,"uncheckAll")}return{mergedCheckedRowKeySetRef:l,mergedCheckedRowKeysRef:d,mergedInderminateRowKeySetRef:v,someRowsCheckedRef:h,allRowsCheckedRef:c,headerCheckboxDisabledRef:f,doUpdateCheckedRowKeys:b,doCheckAll:P,doUncheckAll:T,doCheck:x,doUncheck:y}}function lt(e){return typeof e=="object"&&typeof e.multiple=="number"?e.multiple:!1}function Io(e,t){return t&&(e===void 0||e==="default"||typeof e=="object"&&e.compare==="default")?Ko(t):typeof e=="function"?e:e&&typeof e=="object"&&e.compare&&e.compare!=="default"?e.compare:!1}function Ko(e){return(t,n)=>{const r=t[e],o=n[e];return r==null?o==null?0:-1:o==null?1:typeof r=="number"&&typeof o=="number"?r-o:typeof r=="string"&&typeof o=="string"?r.localeCompare(o):0}}function Do(e,{dataRelatedColsRef:t,filteredDataRef:n}){const r=[];t.value.forEach(h=>{var c;h.sorter!==void 0&&m(r,{columnKey:h.key,sorter:h.sorter,order:(c=h.defaultSortOrder)!==null&&c!==void 0?c:!1})});const o=K(r),i=R(()=>{const h=t.value.filter(b=>b.type!=="selection"&&b.sorter!==void 0&&(b.sortOrder==="ascend"||b.sortOrder==="descend"||b.sortOrder===!1)),c=h.filter(b=>b.sortOrder!==!1);if(c.length)return c.map(b=>({columnKey:b.key,order:b.sortOrder,sorter:b.sorter}));if(h.length)return[];const{value:f}=o;return Array.isArray(f)?f:f?[f]:[]}),u=R(()=>{const h=i.value.slice().sort((c,f)=>{const b=lt(c.sorter)||0;return(lt(f.sorter)||0)-b});return h.length?n.value.slice().sort((f,b)=>{let x=0;return h.some(y=>{const{columnKey:P,sorter:T,order:w}=y,z=Io(T,P);return z&&w&&(x=z(f.rawNode,b.rawNode),x!==0)?(x=x*mo(w),!0):!1}),x}):n.value});function d(h){let c=i.value.slice();return h&&lt(h.sorter)!==!1?(c=c.filter(f=>lt(f.sorter)!==!1),m(c,h),c):h||null}function s(h){const c=d(h);l(c)}function l(h){const{"onUpdate:sorter":c,onUpdateSorter:f,onSorterChange:b}=e;c&&Z(c,h),f&&Z(f,h),b&&Z(b,h),o.value=h}function v(h,c="ascend"){if(!h)p();else{const f=t.value.find(x=>x.type!=="selection"&&x.type!=="expand"&&x.key===h);if(!(f!=null&&f.sorter))return;const b=f.sorter;s({columnKey:h,sorter:b,order:c})}}function p(){l(null)}function m(h,c){const f=h.findIndex(b=>(c==null?void 0:c.columnKey)&&b.columnKey===c.columnKey);f!==void 0&&f>=0?h[f]=c:h.push(c)}return{clearSorter:p,sort:v,sortedDataRef:u,mergedSortStateRef:i,deriveNextSorter:s}}function jo(e,{dataRelatedColsRef:t}){const n=R(()=>{const C=M=>{for(let L=0;L<M.length;++L){const $=M[L];if("children"in $)return C($.children);if($.type==="selection")return $}return null};return C(e.columns)}),r=R(()=>{const{childrenKey:C}=e;return tn(e.data,{ignoreEmptyChildren:!0,getKey:e.rowKey,getChildren:M=>M[C],getDisabled:M=>{var L,$;return!!(!(($=(L=n.value)===null||L===void 0?void 0:L.disabled)===null||$===void 0)&&$.call(L,M))}})}),o=ke(()=>{const{columns:C}=e,{length:M}=C;let L=null;for(let $=0;$<M;++$){const j=C[$];if(!j.type&&L===null&&(L=$),"tree"in j&&j.tree)return $}return L||0}),i=K({}),{pagination:u}=e,d=K(u&&u.defaultPage||1),s=K(gn(u)),l=R(()=>{const C=t.value.filter($=>$.filterOptionValues!==void 0||$.filterOptionValue!==void 0),M={};return C.forEach($=>{var j;$.type==="selection"||$.type==="expand"||($.filterOptionValues===void 0?M[$.key]=(j=$.filterOptionValue)!==null&&j!==void 0?j:null:M[$.key]=$.filterOptionValues)}),Object.assign(Wt(i.value),M)}),v=R(()=>{const C=l.value,{columns:M}=e;function L(se){return(de,ae)=>!!~String(ae[se]).indexOf(String(de))}const{value:{treeNodes:$}}=r,j=[];return M.forEach(se=>{se.type==="selection"||se.type==="expand"||"children"in se||j.push([se.key,se])}),$?$.filter(se=>{const{rawNode:de}=se;for(const[ae,g]of j){let N=C[ae];if(N==null||(Array.isArray(N)||(N=[N]),!N.length))continue;const pe=g.filter==="default"?L(ae):g.filter;if(g&&typeof pe=="function")if(g.filterMode==="and"){if(N.some(ve=>!pe(ve,de)))return!1}else{if(N.some(ve=>pe(ve,de)))continue;return!1}}return!0}):[]}),{sortedDataRef:p,deriveNextSorter:m,mergedSortStateRef:h,sort:c,clearSorter:f}=Do(e,{dataRelatedColsRef:t,filteredDataRef:v});t.value.forEach(C=>{var M;if(C.filter){const L=C.defaultFilterOptionValues;C.filterMultiple?i.value[C.key]=L||[]:L!==void 0?i.value[C.key]=L===null?[]:L:i.value[C.key]=(M=C.defaultFilterOptionValue)!==null&&M!==void 0?M:null}});const b=R(()=>{const{pagination:C}=e;if(C!==!1)return C.page}),x=R(()=>{const{pagination:C}=e;if(C!==!1)return C.pageSize}),y=qe(b,d),P=qe(x,s),T=ke(()=>{const C=y.value;return e.remote?C:Math.max(1,Math.min(Math.ceil(v.value.length/P.value),C))}),w=R(()=>{const{pagination:C}=e;if(C){const{pageCount:M}=C;if(M!==void 0)return M}}),z=R(()=>{if(e.remote)return r.value.treeNodes;if(!e.pagination)return p.value;const C=P.value,M=(T.value-1)*C;return p.value.slice(M,M+C)}),_=R(()=>z.value.map(C=>C.rawNode));function B(C){const{pagination:M}=e;if(M){const{onChange:L,"onUpdate:page":$,onUpdatePage:j}=M;L&&Z(L,C),j&&Z(j,C),$&&Z($,C),U(C)}}function k(C){const{pagination:M}=e;if(M){const{onPageSizeChange:L,"onUpdate:pageSize":$,onUpdatePageSize:j}=M;L&&Z(L,C),j&&Z(j,C),$&&Z($,C),I(C)}}const S=R(()=>{if(e.remote){const{pagination:C}=e;if(C){const{itemCount:M}=C;if(M!==void 0)return M}return}return v.value.length}),G=R(()=>Object.assign(Object.assign({},e.pagination),{onChange:void 0,onUpdatePage:void 0,onUpdatePageSize:void 0,onPageSizeChange:void 0,"onUpdate:page":B,"onUpdate:pageSize":k,page:T.value,pageSize:P.value,pageCount:S.value===void 0?w.value:void 0,itemCount:S.value}));function U(C){const{"onUpdate:page":M,onPageChange:L,onUpdatePage:$}=e;$&&Z($,C),M&&Z(M,C),L&&Z(L,C),d.value=C}function I(C){const{"onUpdate:pageSize":M,onPageSizeChange:L,onUpdatePageSize:$}=e;L&&Z(L,C),$&&Z($,C),M&&Z(M,C),s.value=C}function D(C,M){const{onUpdateFilters:L,"onUpdate:filters":$,onFiltersChange:j}=e;L&&Z(L,C,M),$&&Z($,C,M),j&&Z(j,C,M),i.value=C}function H(C,M,L,$){var j;(j=e.onUnstableColumnResize)===null||j===void 0||j.call(e,C,M,L,$)}function q(C){U(C)}function le(){oe()}function oe(){he({})}function he(C){Y(C)}function Y(C){C?C&&(i.value=Wt(C)):i.value={}}return{treeMateRef:r,mergedCurrentPageRef:T,mergedPaginationRef:G,paginatedDataRef:z,rawPaginatedDataRef:_,mergedFilterStateRef:l,mergedSortStateRef:h,hoverKeyRef:K(null),selectionColumnRef:n,childTriggerColIndexRef:o,doUpdateFilters:D,deriveNextSorter:m,doUpdatePageSize:I,doUpdatePage:U,onUnstableColumnResize:H,filter:Y,filters:he,clearFilter:le,clearFilters:oe,clearSorter:f,page:q,sort:c}}function Vo(e,{mainTableInstRef:t,mergedCurrentPageRef:n,bodyWidthRef:r}){let o=0;const i=K(),u=K(null),d=K([]),s=K(null),l=K([]),v=R(()=>Be(e.scrollX)),p=R(()=>e.columns.filter(k=>k.fixed==="left")),m=R(()=>e.columns.filter(k=>k.fixed==="right")),h=R(()=>{const k={};let S=0;function G(U){U.forEach(I=>{const D={start:S,end:0};k[_e(I)]=D,"children"in I?(G(I.children),D.end=S):(S+=Ht(I)||0,D.end=S)})}return G(p.value),k}),c=R(()=>{const k={};let S=0;function G(U){for(let I=U.length-1;I>=0;--I){const D=U[I],H={start:S,end:0};k[_e(D)]=H,"children"in D?(G(D.children),H.end=S):(S+=Ht(D)||0,H.end=S)}}return G(m.value),k});function f(){var k,S;const{value:G}=p;let U=0;const{value:I}=h;let D=null;for(let H=0;H<G.length;++H){const q=_e(G[H]);if(o>(((k=I[q])===null||k===void 0?void 0:k.start)||0)-U)D=q,U=((S=I[q])===null||S===void 0?void 0:S.end)||0;else break}u.value=D}function b(){d.value=[];let k=e.columns.find(S=>_e(S)===u.value);for(;k&&"children"in k;){const S=k.children.length;if(S===0)break;const G=k.children[S-1];d.value.push(_e(G)),k=G}}function x(){var k,S;const{value:G}=m,U=Number(e.scrollX),{value:I}=r;if(I===null)return;let D=0,H=null;const{value:q}=c;for(let le=G.length-1;le>=0;--le){const oe=_e(G[le]);if(Math.round(o+(((k=q[oe])===null||k===void 0?void 0:k.start)||0)+I-D)<U)H=oe,D=((S=q[oe])===null||S===void 0?void 0:S.end)||0;else break}s.value=H}function y(){l.value=[];let k=e.columns.find(S=>_e(S)===s.value);for(;k&&"children"in k&&k.children.length;){const S=k.children[0];l.value.push(_e(S)),k=S}}function P(){const k=t.value?t.value.getHeaderElement():null,S=t.value?t.value.getBodyElement():null;return{header:k,body:S}}function T(){const{body:k}=P();k&&(k.scrollTop=0)}function w(){i.value!=="body"?wt(_):i.value=void 0}function z(k){var S;(S=e.onScroll)===null||S===void 0||S.call(e,k),i.value!=="head"?wt(_):i.value=void 0}function _(){const{header:k,body:S}=P();if(!S)return;const{value:G}=r;if(G!==null){if(e.maxHeight||e.flexHeight){if(!k)return;const U=o-k.scrollLeft;i.value=U!==0?"head":"body",i.value==="head"?(o=k.scrollLeft,S.scrollLeft=o):(o=S.scrollLeft,k.scrollLeft=o)}else o=S.scrollLeft;f(),b(),x(),y()}}function B(k){const{header:S}=P();S&&(S.scrollLeft=k,_())}return nn(n,()=>{T()}),{styleScrollXRef:v,fixedColumnLeftMapRef:h,fixedColumnRightMapRef:c,leftFixedColumnsRef:p,rightFixedColumnsRef:m,leftActiveFixedColKeyRef:u,leftActiveFixedChildrenColKeysRef:d,rightActiveFixedColKeyRef:s,rightActiveFixedChildrenColKeysRef:l,syncScrollState:_,handleTableBodyScroll:z,handleTableHeaderScroll:w,setHeaderScrollLeft:B}}function Ho(){const e=K({});function t(o){return e.value[o]}function n(o,i){Cn(o)&&"key"in o&&(e.value[o.key]=i)}function r(){e.value={}}return{getResizableWidth:t,doUpdateResizableWidth:n,clearResizableWidth:r}}function Wo(e,t){const n=[],r=[],o=[],i=new WeakMap;let u=-1,d=0,s=!1;function l(m,h){h>u&&(n[h]=[],u=h);for(const c of m)if("children"in c)l(c.children,h+1);else{const f="key"in c?c.key:void 0;r.push({key:_e(c),style:yo(c,f!==void 0?Be(t(f)):void 0),column:c}),d+=1,s||(s=!!c.ellipsis),o.push(c)}}l(e,0);let v=0;function p(m,h){let c=0;m.forEach(f=>{var b;if("children"in f){const x=v,y={column:f,colSpan:0,rowSpan:1,isLast:!1};p(f.children,h+1),f.children.forEach(P=>{var T,w;y.colSpan+=(w=(T=i.get(P))===null||T===void 0?void 0:T.colSpan)!==null&&w!==void 0?w:0}),x+y.colSpan===d&&(y.isLast=!0),i.set(f,y),n[h].push(y)}else{if(v<c){v+=1;return}let x=1;"titleColSpan"in f&&(x=(b=f.titleColSpan)!==null&&b!==void 0?b:1),x>1&&(c=v+x);const y=v+x===d,P={column:f,colSpan:x,rowSpan:u-h+1,isLast:y};i.set(f,P),n[h].push(P),v+=1}})}return p(e,0),{hasEllipsis:s,rows:n,cols:r,dataRelatedCols:o}}function Go(e,t){const n=R(()=>Wo(e.columns,t));return{rowsRef:R(()=>n.value.rows),colsRef:R(()=>n.value.cols),hasEllipsisRef:R(()=>n.value.hasEllipsis),dataRelatedColsRef:R(()=>n.value.dataRelatedCols)}}function qo(e,t){const n=ke(()=>{for(const l of e.columns)if(l.type==="expand")return l.renderExpand}),r=ke(()=>{let l;for(const v of e.columns)if(v.type==="expand"){l=v.expandable;break}return l}),o=K(e.defaultExpandAll?n!=null&&n.value?(()=>{const l=[];return t.value.treeNodes.forEach(v=>{var p;!((p=r.value)===null||p===void 0)&&p.call(r,v.rawNode)&&l.push(v.key)}),l})():t.value.getNonLeafKeys():e.defaultExpandedRowKeys),i=ne(e,"expandedRowKeys"),u=ne(e,"stickyExpandedRows"),d=qe(i,o);function s(l){const{onUpdateExpandedRowKeys:v,"onUpdate:expandedRowKeys":p}=e;v&&Z(v,l),p&&Z(p,l),o.value=l}return{stickyExpandedRowsRef:u,mergedExpandedRowKeysRef:d,renderExpandRef:n,expandableRef:r,doUpdateExpandedRowKeys:s}}const Zt=Zo(),Xo=X([F("data-table",`
 ...
 `))]);function Zo(){return[A("fixed-left",`
 left: 0;
 position: sticky;
 z-index: 2;
 `,[X("&::after",`
