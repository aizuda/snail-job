...
import com.aizuda.snail.job.server.common.dto.DistributeInstance;
import com.aizuda.snail.job.server.common.dto.ServerNodeExtAttrs;
import com.aizuda.snail.job.server.common.enums.DashboardLineEnum;
...
import com.aizuda.snail.job.server.common.register.ServerRegister;
...
import com.aizuda.snail.job.server.web.model.enums.DateTypeEnum;
...
import com.aizuda.snail.job.server.web.service.DashBoardService;
...
import com.aizuda.snail.job.server.web.service.convert.DispatchQuantityResponseVOConverter;
import com.aizuda.snail.job.server.web.service.convert.JobSummaryResponseVOConverter;
import com.aizuda.snail.job.server.web.service.convert.RetrySummaryResponseVOConverter;
import com.aizuda.snail.job.server.web.service.convert.SceneQuantityRankResponseVOConverter;
import com.aizuda.snail.job.server.web.service.convert.ServerNodeResponseVOConverter;
...
import com.aizuda.snail.job.template.datasource.persistence.mapper.JobSummaryMapper;
import com.aizuda.snail.job.template.datasource.persistence.mapper.RetrySummaryMapper;
...
import com.aizuda.snail.job.template.datasource.persistence.po.JobSummary;
...
public class DashBoardServiceImpl implements DashBoardService {
    ...
    public DashboardRetryLineResponseVO retryLineList(BaseQueryVO baseQueryVO, String groupName, String type, String startTime, String endTime) {
        ...
        PageResult<List<Task>> pageResult = new PageResult<>(new PageDTO(pager.getCurrent(), pager.getSize(), pager.getTotal()), taskList);
