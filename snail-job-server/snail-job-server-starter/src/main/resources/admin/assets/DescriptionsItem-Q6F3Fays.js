import{az as p,aA as e,aE as V,aB as C,aD as O,di as G,dj as H,d as E,aF as K,aI as L,dk as N,a as D,b7 as T,aP as W,cs as q,dl as J,ap as n,dm as Q,dn as U}from"./index-KP_OAqI5.js";function M(r,b="default",a=[]){const{children:i}=r;if(i!==null&&typeof i=="object"&&!Array.isArray(i)){const l=i[b];if(typeof l=="function")return l()}return a}const F="DESCRIPTION_ITEM_FLAG";function X(r){return typeof r=="object"&&r&&!Array.isArray(r)?r.type&&r.type[F]:!1}const Y=p([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
