import{as as a,aw as d,ar as o,at as e,av as s,d as f,ax as b,de as p,aG as g,dx as h,bF as m,aj as $}from"./index-DQvTTbM-.js";const t="0!important",u="-1px!important";function i(r){return e(r+"-type",[o("& +",[a("button",{},[e(r+"-type",[s("border",{borderLeftWidth:t}),s("state-border",{left:u})])])])])}function n(r){return e(r+"-type",[o("& +",[a("button",[e(r+"-type",[s("border",{borderTopWidth:t}),s("state-border",{top:u})])])])])}const x=a("button-group",`
 flex-wrap: nowrap;
 display: inline-flex;
 position: relative;
