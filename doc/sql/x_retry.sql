...
(
    ...
    `group_partition` tinyint(4) NOT NULL COMMENT '分区',
...
(
    ...
    `notify_address`   varchar(512) NOT NULL COMMENT '通知地址',
    `notify_threshold` tinyint(4) NOT NULL DEFAULT '0' COMMENT '通知阈值',
