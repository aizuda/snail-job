...
(
    ...
    serializer_name varchar(32)  DEFAULT 'jackson'                          NULL,
    args_str        text                                                    NULL,
    ext_attrs       text                                                    NULL,
    create_dt       datetime     DEFAULT CURRENT_TIMESTAMP                  NOT NULL
);
...
(
    ...
    cb_max_count        int          DEFAULT 16                                 NOT NULL,
    cb_trigger_interval varchar(16)  DEFAULT ''                                 NULL,
    owner_id            bigint       DEFAULT NULL                               NULL,
...
(
    ...
    namespace_id  varchar(64) DEFAULT '764d604ec6fc45f68cd92514c40e9e1a' NULL,
    group_name    varchar(64)                                            NULL,
    executor_info varchar(256)                                           NULL,
    executor_type varchar(3)                                             NULL,
    create_dt     datetime    DEFAULT CURRENT_TIMESTAMP                  NOT NULL,
    update_dt     datetime    DEFAULT CURRENT_TIMESTAMP                  NOT NULL
);
