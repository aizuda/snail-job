import{bc as p,bd as e,dt as F,du as G,bx as H,be as C,bR as B,d as E,dv as K,ai as n,dw as N,dx as W,bf as q,bg as L,dy as J,a as M,ca as j,bi as Q,cz as U}from"./index-DrjO7DLg.js";function D(r,b="default",a=[]){const{children:i}=r;if(i!==null&&typeof i=="object"&&!Array.isArray(i)){const l=i[b];if(typeof l=="function")return l()}return a}const X=p([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
