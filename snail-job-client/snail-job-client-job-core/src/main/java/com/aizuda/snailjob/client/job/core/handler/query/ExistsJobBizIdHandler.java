...
public class ExistsJobBizIdHandler extends AbstractJobRequestHandler<JobExistsResponse> {

    private final String bizId;

    public ExistsJobBizIdHandler(String bizId) {
        this.bizId = bizId;
    }
    ...
    protected JobExistsResponse doExecute() {
        Result<JobExistsResponse> result = clientV2.existsJobByBizId(bizId);
