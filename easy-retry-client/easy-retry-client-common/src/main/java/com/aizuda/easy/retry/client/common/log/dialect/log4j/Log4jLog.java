...
import com.aizuda.easy.retry.client.common.log.AbstractLog;
...
public class Log4jLog extends AbstractLog {
    ...
    public void trace(String fqcn, Throwable t, String format, Boolean remote, Object... arguments) {
        log(fqcn, com.aizuda.easy.retry.client.common.log.level.Level.TRACE, t, format, remote, arguments);
    }
    ...
    public void debug(String fqcn, Throwable t, String format, Boolean remote, Object... arguments) {
        log(fqcn, com.aizuda.easy.retry.client.common.log.level.Level.DEBUG, t, format, remote, arguments);
    }
    ...
    public void info(String fqcn, Throwable t, String format, Boolean remote, Object... arguments) {
        log(fqcn, com.aizuda.easy.retry.client.common.log.level.Level.INFO, t, format, remote, arguments);
    }
    ...
    public void warn(String fqcn, Throwable t, String format, Boolean remote, Object... arguments) {
        log(fqcn, com.aizuda.easy.retry.client.common.log.level.Level.WARN, t, format, remote, arguments);
    }
    ...
    public void error(String fqcn, Throwable t, String format, Boolean remote, Object... arguments) {
        log(fqcn, com.aizuda.easy.retry.client.common.log.level.Level.ERROR, t, format, remote, arguments);
    }

    // ------------------------------------------------------------------------- Log
    @Override
    public void log(String fqcn, com.aizuda.easy.retry.client.common.log.level.Level level, Throwable t, String format, Boolean remote, Object... arguments) {
