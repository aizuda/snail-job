...
public class TinyLog extends AbstractLog {
    ...
    @Override
    public boolean isEnabled(com.aizuda.easy.retry.client.common.log.level.Level level) {
     ...
     * @since 4.0.3
     */
    private Level toTinyLevel(com.aizuda.easy.retry.client.common.log.level.Level level) {
        Level tinyLevel;
        switch (level) {
            case TRACE:
