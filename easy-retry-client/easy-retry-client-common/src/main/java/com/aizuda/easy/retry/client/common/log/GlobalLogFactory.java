...
public class GlobalLogFactory {
     ...
     * @return 自定义的日志工厂类
     * @see com.aizuda.easy.retry.client.common.log.dialect.slf4j.Slf4jLogFactory
     * @see com.aizuda.easy.retry.client.common.log.dialect.log4j.Log4jLogFactory
     * @see com.aizuda.easy.retry.client.common.log.dialect.log4j2.Log4j2LogFactory
     * @see com.aizuda.easy.retry.client.common.log.dialect.commons.ApacheCommonsLogFactory
     * @see com.aizuda.easy.retry.client.common.log.dialect.jdk.JdkLogFactory
     * @see com.aizuda.easy.retry.client.common.log.dialect.console.ConsoleLogFactory
     */
